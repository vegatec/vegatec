...
import net.vegatec.media_library.config.Constants;
import net.vegatec.media_library.query.domain.Authority;
import net.vegatec.media_library.query.domain.User;
import net.vegatec.media_library.query.repository.AuthorityRepository;
...
import net.vegatec.media_library.security.SecurityUtils;
import net.vegatec.media_library.query.service.dto.AdminUserDTO;
import net.vegatec.media_library.query.service.dto.UserDTO;
