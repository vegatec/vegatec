...
public class MediaFileImporter implements Runnable {
    ...
    public void run() {
        try {
            ...
            Path folder = Paths.get(applicationProperties.getMediaFolder(), MediaFileAggregate.DOWNLOADED);
            ...
            while ((key = watchService.take()) != null) {
                for (WatchEvent<?> event : key.pollEvents()) {
                    ...
                    Long id= java.lang.System.currentTimeMillis();

                    CreateMediaFile command= new CreateMediaFile(id, path.toFile());//buildCreateMediaFileCommand(java.lang.System.currentTimeMillis(), path.toFile());
