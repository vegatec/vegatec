package net.vegatec.media_library.service.criteria;
...
/**
 * Criteria class for the {@link net.vegatec.media_library.domain.MusicRequest} entity. This class is used
 * in {@link net.vegatec.media_library.web.rest.MusicRequestResource} to receive all the possible filtering options from
