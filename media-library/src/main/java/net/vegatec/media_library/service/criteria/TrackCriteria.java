...
/**
 * Criteria class for the {@link net.vegatec.media_library.domain.Track} entity. This class is used
 * in {@link net.vegatec.media_library.web.rest.TrackResource} to receive all the possible filtering options from
