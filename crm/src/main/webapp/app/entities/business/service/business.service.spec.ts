...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../business.test-samples';

import { BusinessService } from './business.service';

const requireRestSample: IBusiness = {
...
describe('Business Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Business', () => {
      const business = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(business).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Business', () => {
      const business = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(business).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addBusinessToCollectionIfMissing', () => {
      it('should add a Business to an empty array', () => {
        const business: IBusiness = sampleWithRequiredData;
      ...
      it("should add a Business to an array that doesn't contain it", () => {
        const business: IBusiness = sampleWithRequiredData;
        const businessCollection: IBusiness[] = [sampleWithPartialData];
        expectedResult = service.addBusinessToCollectionIfMissing(businessCollection, business);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(business);
      });
      ...
      it('should add only unique Business to an array', () => {
        const businessArray: IBusiness[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const businessCollection: IBusiness[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const business: IBusiness = sampleWithRequiredData;
        const business2: IBusiness = sampleWithPartialData;
    ...
    describe('compareBusiness', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareBusiness(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareBusiness(entity1, entity2);
        const compareResult2 = service.compareBusiness(entity2, entity1);
