...
@Component({
  standalone: true,
  selector: 'jhi-product-components',
...
export class ProductComponentsComponent implements OnInit {
  ...
  delete(e: any, product: IProduct): void {
    this.productService.removeProduct(this.productId, product.id).subscribe(r => this.reset());
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    if (this.productId) queryObject['componentOfId.equals'] = this.productId;
